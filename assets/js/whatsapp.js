...
//     let number = "+9779814338574";
//     let fullName = document.getElementById("fullName").value; // Updated to match the form ID
//     let emailAddress = document.getElementById("emailAddress").value;
//     let location = document.getElementById("location").value;
//     let totalPerson = document.getElementById("totalPerson").value; // Removed parseInt()
//     let bookingDate = document.getElementById("bookingDate").value;
//     let message = document.getElementById("message").value;
//     const messageurl = 'I am here: ${location}';

//     // Basic validation (optional)
//     if (!fullName || !emailAddress || !totalPerson || !bookingDate || !message || !location) {
...
//       + "Email Address: " + encodeURIComponent(emailAddress) + "%0a"
//       + "location: " +encodeURIComponent(location) + "%0a"
//       + "Total Person: " + encodeURIComponent(totalPerson) + "%0a"
//       + "Booking Date: " + encodeURIComponent(bookingDate) + "%0a"
